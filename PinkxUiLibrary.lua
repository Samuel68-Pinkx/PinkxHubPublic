...
local Themes = {
	PinkX = {
		...
		NavBar = Color3.fromRGB(255,115,232),
		NavBarAccent = Color3.fromRGB(255,255,255),
		NavBarInvert = Color3.fromRGB(30,30,30),
		TitleBar = Color3.fromRGB(255,115,232),
		TitleBarAccent = Color3.fromRGB(255,255,255),
		Overlay = Color3.fromRGB(255,115,232),
		Banner = Color3.fromRGB(255,255,255),
		BannerAccent = Color3.fromRGB(255,115,232),
		Content = Color3.fromRGB(255,115,232),
		Button = Color3.fromRGB(255,115,232),
		ButtonAccent = Color3.fromRGB(255,255,255),
		ChipSet = Color3.fromRGB(255,115,232),
		ChipSetAccent = Color3.fromRGB(255,255,255),
		DataTable = Color3.fromRGB(255,115,232),
		DataTableAccent = Color3.fromRGB(255,255,255),
		Slider = Color3.fromRGB(255,255,255),
		SliderAccent = Color3.fromRGB(255,115,232),
		Toggle = Color3.fromRGB(255,115,232),
		ToggleAccent = Color3.fromRGB(255,255,255),
		Dropdown = Color3.fromRGB(255,255,255),
		DropdownAccent = Color3.fromRGB(255,115,232),
		ColorPicker = Color3.fromRGB(255,255,255),
		ColorPickerAccent = Color3.fromRGB(255,115,232),
		TextField = Color3.fromRGB(255,115,232),
		TextFieldAccent = Color3.fromRGB(255,115,232),
	},
	Dark = {
...
function Material.Load(Config)
	...
	function TabLibrary.New(TabConfig)
		...
		function OptionLibrary.Slider(SliderConfig)
			...
			local SliderTracker = Objects.new("CircleButton")
			...
			SliderTracker.Parent = Slider
                        ...
                        local SliderTracker2 = Objects.new("Frame")
			SliderTracker2.BackgroundColor3 = Theme.SliderAccent
			SliderTracker2.BackgroundTransparency = 1
			SliderTracker2.Size = UDim2.fromScale(1,0) + UDim2.fromOffset(-20,3)
			SliderTracker2.Position = UDim2.fromScale(0,1) + UDim2.fromOffset(10,-10)
			SliderTracker2.Parent = Slider

                       

			local SliderFill = SliderTracker2:Clone()
...
SliderDot.MouseButton1Down:Connect(function()
	...
	local Px = GetXY(SliderTracker2)
			...
			if MenuAdded then
				...
				SliderTracker2.Size -= UDim2.fromOffset(20,0)
